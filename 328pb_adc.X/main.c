...
int main(void) {
    ...
    while (1) {
        ...
        sprintf(intStringBuffer, "ADC Read:\t %d", ADC); // Convert integer to string
...
int main(void) {
    ...
    while (1) {
        ...
        char intStringBuffer[20]; // Buffer to hold the converted number
        sprintf(intStringBuffer, "Raw ADC Read:\t %d", currentAdcRead); // Convert integer to string
        __PRINT_NEW_LINE__ // Make space between prints
        UART_putstring(intStringBuffer);
        _delay_ms(2000);
    }
...
int main(void) {
    ...
    while (1) {
        if (print_flag) {
            ...
            char intStringBuffer[20]; // Buffer to hold the converted number
            sprintf(intStringBuffer, "Count:\t %d", count); // Convert integer to string
            __PRINT_NEW_LINE__ // Make space between prints
            UART_putstring(intStringBuffer);
        }
    }
